...
RUN curl http://nodejs.org/dist/v0.10.29/node-v0.10.29.tar.gz > node-v0.10.29.tar.gz; tar xvf node-v0.10.29.tar.gz; cd node-v0.10.29; ./configure; make; make install;
